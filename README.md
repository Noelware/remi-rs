...
> [!NOTE]
>
> As of the v0.5 release, `remi-rs` will be our main priority while the Java-based version will be in maintenance mode.
...
## Supported
- **Oracle Cloud Infrastructure Object Storage** (with the `remi-oci` crate)
